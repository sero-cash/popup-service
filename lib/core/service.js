        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    console.log("tx >>> signRet: ", signRet_1, JSON.stringify(signRet_1));
                    return [4 /*yield*/, jsonRpcReq('sero_commitTx', [signRet_1])];
                case 4:
                    resp_1 = _a.sent();
                    console.log("tx >>> resp: ", resp_1);
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            // @ts-ignore
            ...
            if (isSyncing === false) {
                ...
                if (db) {
                    db.forEach(function (_db) {
                        isSyncing = true;
                        _fetchOuts(_db).then(function (rest) {
...
function _checkNil(tk) {
    return __awaiter(this, void 0, void 0, function () {
        var nils, nilArr, _i, nils_1, nil, resp, datas, _a, datas_1, data, txInfo, nil, nilDatas, _b, nilDatas_1, nilData, root, utxos, utxo, txBase, currency, assets, cy, txCurrency;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 11:
                    _c.sent();
                    if (utxo.Asset && utxo.Asset.Tkn) {
                        cy = utils_1.default.hexToCy(utxo.Asset.Tkn.Currency);
                        txCurrency = {
                            Num: txInfo.Num,
                            TxHash: txInfo.TxHash,
                            Currency: utils_1.default.hexToCy(utxo.Asset.Tkn.Currency),
